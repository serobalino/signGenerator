                ...
                <table style="font-size: medium; font-family: Trebuchet MS;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                            ...
                            <table style="font-size: medium; font-family: Trebuchet MS;" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <table style="font-size: medium; font-family: Trebuchet MS; display: inline-block;" cellspacing="0" cellpadding="0">
                                            <tbody>
                        ...
                        <td style="padding: 0px; vertical-align: middle;">
                            <h4 style="margin: 0px; font-size: 16px; color: rgb(0, 0, 0);" color="#000000" ><span>{{$nombre_re}}</span><span>&nbsp;</span><span>{{$apellido_re}}</span></h4>
                            <p style="margin: 0px; color: rgb(0, 0, 0); font-size: 13px; line-height: 13px;" color="#000000" font-size="medium" ><span>{{$cargo['nombre_ca']}}</span></p>
                            <p style="margin: 0px; font-weight: 500; color: rgb(0, 0, 0); font-size: 13px; line-height: 13px;" color="#000000" font-size="medium" ><span>{{$cargo['departamento']['titulo_de']}}</span><span>&nbsp;|&nbsp;</span><span>{{$cargo['departamento']['empresa']['nombrel_em']}}</span></p>
                            <div>
                                <table style="width: 100%;" cellspacing="0" cellpadding="0">
                                    <tbody>
                                    <tr>
                                        <td style="width: 100%; border-bottom: 1px solid {{$cargo['departamento']['empresa']['color_em']}}; border-left: medium none; display: block;" color="{{$cargo['departamento']['empresa']['color_em']}}" direction="horizontal"  height="1"></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
